...
import _ from 'lodash'; // jquery lodash bản chất thay đổi hàm javascripts : dùng để check user có rỗng hay k
class ModalEditUser extends Component {
    ...
    componentDidMount() {
        ...
        if (user && !_.isEmpty(user)) {
            this.setState({
                id: user.id, //id trong suốt với người dùng
                email: user.email,
                password: 'harcode',
    ...
    render() {
        ...
        return (
            <Modal isOpen={this.props.isOpen}
                ...
                centered
            >
                <ModalHeader toggle={() => { this.toggle() }} > Edit a Users</ModalHeader>
                <ModalBody>
